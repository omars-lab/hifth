...
import { copyrightBlock } from "./morphology.mjs";
...
// The block is read out of the source file itself by `copyrightBlock()`, which
// build-adjacency.mjs also calls: two trees derived from this corpus reproduce
// one quotation, and a quotation with two readers is a quotation that drifts.
// The bytes below are unchanged by that extraction — the function is the same
// find-the-last-rule walk that lived here, moved to where both callers are.
writeFileSync(
