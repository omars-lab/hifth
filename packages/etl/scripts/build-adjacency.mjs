...
const twinPairs = TWINS.reduce((n, c) => n + (c.length * (c.length - 1)) / 2, 0);
...
console.log(
  `build-adjacency — ${datasetDirected} dataset + ${curatedCount} curated + ${twinPairs} whole-verse twin directed edges → ` +
