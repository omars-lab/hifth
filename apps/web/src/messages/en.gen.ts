...
const messages: Catalog = {
  ...
  commentaryEmpty: "No commentary for this ayah",
  commentaryLemma: (d) => select(d.range, { yes: "Ayahs " + d.aText + "–" + d.zText, other: "Ayah " + d.aText }),
  commentaryOcr: "recovered",
  commentaryOcrNote: "Recovered by OCR — diacritics may be imperfect",
  commentaryRefs: "Cross-references",
  commentarySource: (d) => d.label + " · " + d.license,
  commentaryTitle: "Commentary",
  commentaryTrigger: "Commentary",
  commentaryUnavailable: " · not available yet",
  copied: "Link copied",
  ...
  tafsirImportBody: "A commentary you own can be side-loaded from a folder of files. It is stored only in this browser, never uploaded, and can be removed at any time.",
  tafsirImportBusy: "Reading the folder…",
  tafsirImportButton: "Choose folder…",
  tafsirImportError: (d) => "Could not load that folder: " + d.reason,
  tafsirImportLoaded: (d) => d.label + " is loaded on this device.",
  tafsirImportOk: (d) => d.label + " loaded · " + d.nText + " surahs, " + d.eText + " entries",
  tafsirImportRemove: "Remove",
  tafsirImportTitle: "Commentary edition",
  tafsirImportUnsupported: "This browser cannot store a side-loaded edition.",
