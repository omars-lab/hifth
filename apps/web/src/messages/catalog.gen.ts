...
export interface Catalog {
  ...
  readonly bmClear: string;
  readonly bmClearAll: string;
  readonly bmClearSurahAria: (d: { readonly surah: string | number }) => string;
  readonly bmCleared: (d: { readonly n: number; readonly nText: string | number }) => string;
  readonly bmConfirmAll: (d: { readonly n: number; readonly nText: string | number }) => string;
  readonly bmConfirmSurah: (d: { readonly n: number; readonly surah: string | number; readonly nText: string | number }) => string;
  readonly bmCount: (d: { readonly n: number; readonly nText: string | number }) => string;
  readonly bmDrawerTitle: string;
  readonly bmDrop: string;
  readonly bmDropped: (d: { readonly name: string | number }) => string;
  readonly bmEvent: (d: { readonly what: "dropped" | "renamed" | "moved" | "other"; readonly dayText: string | number; readonly page: string | number }) => string;
  readonly bmGroup: (d: { readonly surah: string | number; readonly nText: string | number }) => string;
  readonly bmHead: string;
  readonly bmHistory: string;
  readonly bmLift: string;
  readonly bmLifted: (d: { readonly name: string | number }) => string;
  readonly bmLoad: string;
  readonly bmLoadBad: string;
  readonly bmLoaded: (d: { readonly n: number; readonly nText: string | number }) => string;
  readonly bmMoveTo: (d: { readonly label: string | number }) => string;
  readonly bmMoved: (d: { readonly name: string | number; readonly page: string | number }) => string;
  readonly bmNameLabel: string;
