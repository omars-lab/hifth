...
<main class="wrap">
  ...
  <h2 class="q">What does this change for a hafiz?</h2>
  <p><span class="hl">Barely. How a turn feels does not change what a hafiz keeps.</span> Many huffaz
  remember a verse by where it sits on the page, but every option here leaves the resting page exactly
  as printed, so none of them touches that memory. Decide it quickly, or leave it open at no cost.</p>
  <ul>
    <li><span class="hl"><b>A · Flat seam:</b> the words never move, so the page you memorised is never smeared mid-turn.</span></li>
    <li><span class="hl"><b>B · Skeleton curl:</b> for a moment the page is grey bars, not the page you know. That is harmless in a quick turn, and odd if you glance at the page while it is still turning.</span></li>
    <li><span class="hl"><b>C · Curl the real words:</b> the most like paper, and the heaviest for a phone. A stutter in the middle of a revision costs more than a plain turn does.</span></li>
    <li><span class="hl"><b>D · Shadow lift:</b> the page stays whole; the only risk is a turn so quiet you are not sure it happened.</span></li>
  </ul>
</section>
