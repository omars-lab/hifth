...
<main>
  ...
  <p><span class="hl">A hafiz who has just slipped wants to mark exactly where — one vowel, one word —
  with one thumb, without losing their place.</span> How many moves that mark takes decides whether it
  gets made at all in the middle of a recitation, and the marked slips are what the next revision is
  built from. The verse's own tools (listen, translate, bookmark) are wanted less often in the middle of
  a recitation, so they can afford a slower door.</p>
  </section>
  ...
  <table>
    ...
    <tr><td>Tap vs hold<br><small>drawn here</small></td><td>A quick tap opens the word drawer; a press
      ...
      asks the build to tell a tap from a hold without misfiring on a scroll.
      <p class="for-hafiz"><span class="hl"><b>For a hafiz:</b> marking a slip on a word is one tap, the fastest of the three. The verse tools take a hold that someone has to show you once.</span></p></td></tr>
    <tr><td>Ask which</td><td>Any press opens one sheet that asks &ldquo;this word, or the whole
      ...
      second tap before any tool, for a choice that is usually obvious.
      <p class="for-hafiz"><span class="hl"><b>For a hafiz:</b> every slip costs a question and a second tap, mid-recitation. It is the most likely of the three to be skipped, and slips left unmarked are lost.</span></p></td></tr>
