...
const CEILINGS = {
  ...
  letters: 2560 * 1024, // 1.88 MB  the lines between each word's letters (letter-parts = A), a few numbers per join; a jump means the shards started carrying the letters' shapes or their spelling rather than where they divide
