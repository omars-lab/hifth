...
- **Should the app colour tajweed one colour a verse, or should it colour the exact letter a rule lands on?**<br>reads with: [The grain gets finer where the finger already is](word-selection.md) · [Loop 6a — Skin, editions, wayfinding, offline foundation](loop-6a.md) · [Whose colours are they?](tajweed-colours.md)
...
- **Should a reader be able to pick single words, or only whole verses?**<br>reads with: [A run of words asks a question, and the answer is a number](word-search.md) · [Sub-word marks: the level below a word, and the print that already named it](../design/sub-word-marks.md)
