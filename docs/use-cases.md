...
| happens in | [`apps/web/src/components/PageStage.tsx:230`](../apps/web/src/components/PageStage.tsx#L230) — `PageStage` |
...
| happens in | [`apps/web/src/components/PageStage.tsx:1080`](../apps/web/src/components/PageStage.tsx#L1080) — `async navigateTo` |
...
| | |
|---|---|
| happens in | [`packages/core/src/keymap.ts:92`](../packages/core/src/keymap.ts#L92) — `appKeyAction` |
...
| proven by | [`apps/web/e2e/page-turn.spec.ts:333`](../apps/web/e2e/page-turn.spec.ts#L333) — “a sideways flick turns the page, and the band tracks the finger” |
...
| | |
|---|---|
| happens in | [`packages/core/src/pages.ts:112`](../packages/core/src/pages.ts#L112) — `spreadOf` |
| happens in | [`apps/web/src/components/PageSpread.tsx:113`](../apps/web/src/components/PageSpread.tsx#L113) — `PageSpread` |
| happens in | [`apps/web/src/useMediaQuery.ts:43`](../apps/web/src/useMediaQuery.ts#L43) — `DESKTOP_QUERY` |
| proven by | [`apps/web/e2e/desktop.spec.ts:129`](../apps/web/e2e/desktop.spec.ts#L129) — “puts the lower page number on the right” |
| proven by | [`apps/web/e2e/desktop.spec.ts:59`](../apps/web/e2e/desktop.spec.ts#L59) — “appears above the breakpoint and does not exist below it” |
| proven by | [`packages/core/src/pages.test.ts:54`](../packages/core/src/pages.test.ts#L54) — “puts the lower page number on the right” |
| proven by | [`apps/web/e2e/desktop.spec.ts:294`](../apps/web/e2e/desktop.spec.ts#L294) — “still turns pages with the arrow keys the header advertises” |
...
|---|---|
| happens in | [`apps/web/src/components/PageSpread.tsx:113`](../apps/web/src/components/PageSpread.tsx#L113) — `PageSpread` |
| happens in | [`apps/web/src/i18n.tsx:405`](../apps/web/src/i18n.tsx#L405) — `facingAbsent` |
| proven by | [`apps/web/e2e/desktop.spec.ts:229`](../apps/web/e2e/desktop.spec.ts#L229) — “announces the missing facing page instead of showing blank paper” |
| proven by | [`apps/web/src/components/PageSpread.test.tsx:73`](../apps/web/src/components/PageSpread.test.tsx#L73) — “draws the missing facing page as absent, not as blank paper” |
| proven by | [`apps/web/src/components/PageSpread.test.tsx:122`](../apps/web/src/components/PageSpread.test.tsx#L122) — “leaves the far side blank and unlabelled at the end of an odd-length print” |

> **Not proven:** This build vendors pages 7, 9 and 19 and none of them are adjacent, so *every* spread is one leaf and one hole — the honest-hole path is the only path a reader can currently reach, and the branch that draws a real facing leaf is exercised by a fixture inventory rather than by the app. Loop 4b (task #27) is what turns that around, and it is the commit that will find anything wrong with the other branch.
...
| proven by | [`apps/web/e2e/desktop.spec.ts:268`](../apps/web/e2e/desktop.spec.ts#L268) — “gives the header the controls the phone had to hide” |
...
| proven by | [`apps/web/e2e/wayfinding.spec.ts:204`](../apps/web/e2e/wayfinding.spec.ts#L204) — “the mushaf picker shows what exists and why the rest does not” |
...
| happens in | [`apps/web/src/components/RevisionMap.tsx:97`](../apps/web/src/components/RevisionMap.tsx#L97) — `coverage` |
...
| proven by | [`apps/web/src/components/RevisionMap.test.tsx:100`](../apps/web/src/components/RevisionMap.test.tsx#L100) — “draws absent as a different kind of thing from cold, not a paler one” |
...
| happens in | [`apps/web/src/i18n.tsx:759`](../apps/web/src/i18n.tsx#L759) — `LangProvider` |
...
| happens in | [`apps/web/src/i18n.tsx:434`](../apps/web/src/i18n.tsx#L434) — `buildStrings` |
...
16 of 38 use cases carry a `gap` — a promise whose proof is thinner than the promise. They are collected here because a hole listed once beside its own use case is a hole nobody counts.
...
- **Do not show me a blank sheet of paper and let me think page 8 is empty. Tell me it is not in this build.** — This build vendors pages 7, 9 and 19 and none of them are adjacent, so *every* spread is one leaf and one hole — the honest-hole path is the only path a reader can currently reach, and the branch that draws a real facing leaf is exercised by a fixture inventory rather than by the app. Loop 4b (task #27) is what turns that around, and it is the commit that will find anything wrong with the other branch.
