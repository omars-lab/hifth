...
|---|---|
| happens in | [`apps/web/src/components/PageSpread.tsx:84`](../apps/web/src/components/PageSpread.tsx#L84) — `PageSpread` |
| happens in | [`apps/web/src/i18n.tsx:347`](../apps/web/src/i18n.tsx#L347) — `facingAbsent` |
...
| happens in | [`apps/web/src/i18n.tsx:927`](../apps/web/src/i18n.tsx#L927) — `LangProvider` |
...
12 of 34 use cases carry a `gap` — a promise whose proof is thinner than the promise. They are collected here because a hole listed once beside its own use case is a hole nobody counts.
