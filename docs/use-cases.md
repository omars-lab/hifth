...
flowchart LR
  subgraph ac_hafiz_g["الحافظ · the hafiz"]
    ...
    uc_see_which_half_of_the_mushaf_is_missing("Do not show me a blank sheet of<br/>paper and let me think page 6 is<br/>empty. Tell me it is not in this<br/>build.")
...
| | |
|---|---|
| happens in | [`packages/core/src/pages.ts:87`](../packages/core/src/pages.ts#L87) — `spreadOf` |
| happens in | [`apps/web/src/components/PageSpread.tsx:84`](../apps/web/src/components/PageSpread.tsx#L84) — `PageSpread` |
| happens in | [`apps/web/src/useMediaQuery.ts:27`](../apps/web/src/useMediaQuery.ts#L27) — `DESKTOP_QUERY` |
| proven by | [`apps/web/e2e/desktop.spec.ts:75`](../apps/web/e2e/desktop.spec.ts#L75) — “puts the lower page number on the right” |
| proven by | [`apps/web/e2e/desktop.spec.ts:42`](../apps/web/e2e/desktop.spec.ts#L42) — “appears above the breakpoint and does not exist below it” |
| proven by | [`packages/core/src/pages.test.ts:54`](../packages/core/src/pages.test.ts#L54) — “puts the lower page number on the right” |
| proven by | [`apps/web/e2e/desktop.spec.ts:147`](../apps/web/e2e/desktop.spec.ts#L147) — “still turns pages with the arrow keys the header advertises” |
...
### Do not show me a blank sheet of paper and let me think page 6 is empty. Tell me it is not in this build.
...
| proven by | [`apps/web/e2e/desktop.spec.ts:95`](../apps/web/e2e/desktop.spec.ts#L95) — “announces the missing facing page instead of showing blank paper” |
| proven by | [`apps/web/src/components/PageSpread.test.tsx:66`](../apps/web/src/components/PageSpread.test.tsx#L66) — “draws the missing facing page as absent, not as blank paper” |
| proven by | [`apps/web/src/components/PageSpread.test.tsx:104`](../apps/web/src/components/PageSpread.test.tsx#L104) — “leaves the far side of page 1 blank and unlabelled” |
...
| proven by | [`apps/web/e2e/desktop.spec.ts:128`](../apps/web/e2e/desktop.spec.ts#L128) — “gives the header the controls the phone had to hide” |
...
15 of 37 use cases carry a `gap` — a promise whose proof is thinner than the promise. They are collected here because a hole listed once beside its own use case is a hole nobody counts.
...
- **Do not show me a blank sheet of paper and let me think page 6 is empty. Tell me it is not in this build.** — This build vendors pages 7, 9 and 19 and none of them are adjacent, so *every* spread is one leaf and one hole — the honest-hole path is the only path a reader can currently reach, and the branch that draws a real facing leaf is exercised by a fixture inventory rather than by the app. Loop 4b (task #27) is what turns that around, and it is the commit that will find anything wrong with the other branch.
