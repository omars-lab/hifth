...
flowchart LR
  subgraph ac_hafiz_g["الحافظ · the hafiz"]
    ...
    uc_learn_the_gestures_once("Let me open straight onto the<br/>page, and show me what I can do<br/>here when I ask.")
...
| happens in | [`apps/web/src/components/PageStage.tsx:403`](../apps/web/src/components/PageStage.tsx#L403) — `PageStage` |
...
| happens in | [`apps/web/src/components/PageStage.tsx:1784`](../apps/web/src/components/PageStage.tsx#L1784) — `applyWords` |
| happens in | [`packages/core/src/adjacency.ts:384`](../packages/core/src/adjacency.ts#L384) — `refineByWords` |
| happens in | [`apps/web/src/App.tsx:1198`](../apps/web/src/App.tsx#L1198) — `const handleSelectWords` |
...
| happens in | [`apps/web/src/components/PageStage.tsx:1441`](../apps/web/src/components/PageStage.tsx#L1441) — `async navigateTo` |
...
| proven by | [`apps/web/e2e/wayfinding.spec.ts:60`](../apps/web/e2e/wayfinding.spec.ts#L60) — “`/` opens the jumper and a jump lands like a link” |
| proven by | [`apps/web/e2e/wayfinding.spec.ts:87`](../apps/web/e2e/wayfinding.spec.ts#L87) — “a jump to an un-vendored ayah is refused, not faked” |
...
| happens in | [`apps/web/src/assets.ts:91`](../apps/web/src/assets.ts#L91) — `loadPage` |
...
| proven by | [`apps/web/e2e/offline.spec.ts:228`](../apps/web/e2e/offline.spec.ts#L228) — “a page that would not load is said, not silently swapped for another” |
...
| | |
|---|---|
| happens in | [`apps/web/src/components/PageSlider.tsx:140`](../apps/web/src/components/PageSlider.tsx#L140) — `PageSlider` |
...
| happens in | [`apps/web/src/components/PageStage.tsx:362`](../apps/web/src/components/PageStage.tsx#L362) — `ZOOM_STEPS` |
...
|---|---|
| happens in | [`apps/web/src/components/PageSpread.tsx:152`](../apps/web/src/components/PageSpread.tsx#L152) — `PageSpread` |
| happens in | [`apps/web/src/i18n.tsx:522`](../apps/web/src/i18n.tsx#L522) — `facingAbsent` |
...
### Let me open straight onto the page, and show me what I can do here when I ask.

`learn-the-gestures-once` · change it with `make map FEATURE=wayfinding`

| | |
|---|---|
| happens in | [`apps/web/src/components/CoachMarks.tsx:80`](../apps/web/src/components/CoachMarks.tsx#L80) — `CoachMarks` |
| proven by | [`apps/web/e2e/wayfinding.spec.ts:29`](../apps/web/e2e/wayfinding.spec.ts#L29) — “the tips wait in settings, teach three verbs, then leave” |
...
| proven by | [`apps/web/e2e/wayfinding.spec.ts:259`](../apps/web/e2e/wayfinding.spec.ts#L259) — “the mushaf picker shows what exists and why the rest does not” |
...
| proven by | [`apps/web/e2e/offline.spec.ts:189`](../apps/web/e2e/offline.spec.ts#L189) — “an evicted shell is rebuilt, so offline still works afterwards” |
...
| proven by | [`apps/web/e2e/offline.spec.ts:561`](../apps/web/e2e/offline.spec.ts#L561) — “a pack the sweep only half took is not left looking kept” |
...
| happens in | [`apps/web/src/components/RevisionMap.tsx:196`](../apps/web/src/components/RevisionMap.tsx#L196) — `holdings` |
...
| happens in | [`apps/web/src/i18n.tsx:1047`](../apps/web/src/i18n.tsx#L1047) — `LangProvider` |
| happens in | [`apps/web/src/components/Colophon.tsx:238`](../apps/web/src/components/Colophon.tsx#L238) — `langRow` |
...
| | |
|---|---|
| happens in | [`apps/web/src/messages/ar.json:144`](../apps/web/src/messages/ar.json#L144) — `distancePages` |
| happens in | [`apps/web/src/messages/plural.ts:39`](../apps/web/src/messages/plural.ts#L39) — `export function plural` |
| happens in | [`apps/web/src/i18n.tsx:616`](../apps/web/src/i18n.tsx#L616) — `buildStrings` |
...
| | |
|---|---|
| happens in | [`apps/web/src/components/Colophon.tsx:68`](../apps/web/src/components/Colophon.tsx#L68) — `CREDITS` |
