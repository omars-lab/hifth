...
| | |
|---|---|
| happens in | [`packages/core/src/gestures.ts:159`](../packages/core/src/gestures.ts#L159) — `pointerIntent` |
...
| | |
|---|---|
| happens in | [`packages/core/src/gestures.ts:62`](../packages/core/src/gestures.ts#L62) — `LONG_PRESS_MS` |
| happens in | [`apps/web/src/components/PageStage.tsx:280`](../apps/web/src/components/PageStage.tsx#L280) — `PageStage` |
...
| happens in | [`apps/web/src/components/PageStage.tsx:1192`](../apps/web/src/components/PageStage.tsx#L1192) — `async navigateTo` |
...
| happens in | [`packages/core/src/gestures.ts:285`](../packages/core/src/gestures.ts#L285) — `turnCommit` |
| happens in | [`apps/web/src/assets.ts:88`](../apps/web/src/assets.ts#L88) — `loadPage` |
...
| proven by | [`apps/web/e2e/offline.spec.ts:453`](../apps/web/e2e/offline.spec.ts#L453) — “a sweep is said out loud, and the juz can be put back” |
| proven by | [`apps/web/e2e/offline.spec.ts:501`](../apps/web/e2e/offline.spec.ts#L501) — “a pack the sweep only half took is not left looking kept” |
...
| happens in | [`apps/web/src/components/Colophon.tsx:205`](../apps/web/src/components/Colophon.tsx#L205) — `langRow` |
...
| | |
|---|---|
| happens in | [`apps/web/src/components/Colophon.tsx:54`](../apps/web/src/components/Colophon.tsx#L54) — `CREDITS` |
...
16 of 39 use cases carry a `gap` — a promise whose proof is thinner than the promise. They are collected here because a hole listed once beside its own use case is a hole nobody counts.
