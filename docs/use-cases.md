...
| happens in | [`apps/web/src/components/PageStage.tsx:1550`](../apps/web/src/components/PageStage.tsx#L1550) — `applyWords` |
| happens in | [`packages/core/src/adjacency.ts:384`](../packages/core/src/adjacency.ts#L384) — `refineByWords` |
| happens in | [`apps/web/src/App.tsx:663`](../apps/web/src/App.tsx#L663) — `const handleSelectWords` |
...
| happens in | [`apps/web/src/i18n.tsx:842`](../apps/web/src/i18n.tsx#L842) — `LangProvider` |
...
| | |
|---|---|
| happens in | [`apps/web/src/messages/ar.json:139`](../apps/web/src/messages/ar.json#L139) — `distancePages` |
| happens in | [`apps/web/src/messages/plural.ts:39`](../apps/web/src/messages/plural.ts#L39) — `export function plural` |
| happens in | [`apps/web/src/i18n.tsx:489`](../apps/web/src/i18n.tsx#L489) — `buildStrings` |
