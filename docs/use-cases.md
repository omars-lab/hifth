...
| happens in | [`apps/web/src/components/Jumper.tsx:89`](../apps/web/src/components/Jumper.tsx#L89) — `Jumper` |
...
| happens in | [`apps/web/src/i18n.tsx:729`](../apps/web/src/i18n.tsx#L729) — `LangProvider` |
...
| proven by | [`apps/web/e2e/lang.spec.ts:83`](../apps/web/e2e/lang.spec.ts#L83) — “the switch is in the colophon, and the choice survives a reload” |
| proven by | [`apps/web/e2e/lang.spec.ts:43`](../apps/web/e2e/lang.spec.ts#L43) — “the mus'haf, the rail and the trail stay right-to-left” |
...
8 of 29 use cases carry a `gap` — a promise whose proof is thinner than the promise. They are collected here because a hole listed once beside its own use case is a hole nobody counts.
