...
| happens in | [`apps/web/src/components/PageStage.tsx:153`](../apps/web/src/components/PageStage.tsx#L153) — `PageStage` |
...
| happens in | [`apps/web/src/components/PageStage.tsx:790`](../apps/web/src/components/PageStage.tsx#L790) — `async navigateTo` |
...
| proven by | [`apps/web/e2e/desktop.spec.ts:287`](../apps/web/e2e/desktop.spec.ts#L287) — “still turns pages with the arrow keys the header advertises” |
...
|---|---|
| happens in | [`apps/web/src/components/PageSpread.tsx:113`](../apps/web/src/components/PageSpread.tsx#L113) — `PageSpread` |
| happens in | [`apps/web/src/i18n.tsx:397`](../apps/web/src/i18n.tsx#L397) — `facingAbsent` |
...
| | |
|---|---|
| happens in | [`apps/web/src/components/DesktopChrome.tsx:22`](../apps/web/src/components/DesktopChrome.tsx#L22) — `DesktopChrome` |
...
| proven by | [`apps/web/src/components/DesktopChrome.test.tsx:101`](../apps/web/src/components/DesktopChrome.test.tsx#L101) — “only hints keys that actually do the thing the hint claims” |
...
| | |
|---|---|
| happens in | [`apps/web/src/lang.ts:102`](../apps/web/src/lang.ts#L102) — `detectLang` |
| happens in | [`apps/web/src/i18n.tsx:766`](../apps/web/src/i18n.tsx#L766) — `LangProvider` |
...
| happens in | [`apps/web/src/i18n.tsx:426`](../apps/web/src/i18n.tsx#L426) — `buildStrings` |
...
| happens in | [`apps/web/src/lang.ts:75`](../apps/web/src/lang.ts#L75) — `LOCALES` |
| happens in | [`apps/web/src/i18n.tsx:426`](../apps/web/src/i18n.tsx#L426) — `buildStrings` |
...
| | |
|---|---|
| happens in | [`scripts/gate-params.mjs:47`](../scripts/gate-params.mjs#L47) — `parseBranches` |
| happens in | [`packages/core/src/field.ts:65`](../packages/core/src/field.ts#L65) — `FIELDS` |
