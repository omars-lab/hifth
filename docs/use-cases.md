...
| happens in | [`apps/web/src/components/PageSpread.tsx:92`](../apps/web/src/components/PageSpread.tsx#L92) — `PageSpread` |
...
| proven by | [`apps/web/e2e/desktop.spec.ts:148`](../apps/web/e2e/desktop.spec.ts#L148) — “still turns pages with the arrow keys the header advertises” |
...
| proven by | [`apps/web/e2e/desktop.spec.ts:96`](../apps/web/e2e/desktop.spec.ts#L96) — “announces the missing facing page instead of showing blank paper” |
| proven by | [`apps/web/src/components/PageSpread.test.tsx:71`](../apps/web/src/components/PageSpread.test.tsx#L71) — “draws the missing facing page as absent, not as blank paper” |
| proven by | [`apps/web/src/components/PageSpread.test.tsx:120`](../apps/web/src/components/PageSpread.test.tsx#L120) — “leaves the far side blank and unlabelled at the end of an odd-length print” |
...
| proven by | [`apps/web/e2e/desktop.spec.ts:129`](../apps/web/e2e/desktop.spec.ts#L129) — “gives the header the controls the phone had to hide” |
