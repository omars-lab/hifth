...
| happens in | [`apps/web/src/components/DiffView.tsx:175`](../apps/web/src/components/DiffView.tsx#L175) — `DiffView` |
...
| proven by | [`apps/web/src/components/DiffView.test.tsx:54`](../apps/web/src/components/DiffView.test.tsx#L54) — “washes the divergent tail ochre on both sides — the same colour, not one each” |
